...
export default function Home() {
  ...
  return (
    <main className=" flex flex-col items-center justify-center md:flex-row  md:items-start lg:justify-center w-screen">
      <Image src="/images/bg.png" alt='not found' width={1280} height={832} className="fixed top-0  h-full  -z-10 left-[37%]" />
      <div className="absolute w-screen h-full top-0 side-gradient-five -z-10 md:hidden"></div>
